var webdriver   = require('wd'),
    ...
    argv        = optimist
      ...
      .options('webSecuritySL', {
        'alias':    'ws',
        'default':  false,
        'boolean':  true,
        'describe': "Define whether Chrome's web security should be enabled or not."
      })
      .options('versionSL', {
        'alias':    'v',
        'default':  '',
    ...
    setConfiguration = function(options) {
      ...
      desired = {
        ...
        "chromeOptions": argv.webSecuritySL ? {} : {'args': ['--disable-web-security'] },
